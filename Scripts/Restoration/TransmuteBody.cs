...
{
    public class TransmuteBody : TransmuteEffect
    {
        private static readonly string effectKey = "TransmuteBody";
        ...
        public override string GroupName => "TransmuteBody"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
