...
{
    public class HealMind : HealEffect
    {
        private static readonly string effectKey = "HealMind";
        ...
        public override string GroupName => "HealMind"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
