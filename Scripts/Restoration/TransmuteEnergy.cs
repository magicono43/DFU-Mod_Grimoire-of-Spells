...
{
    public class TransmuteEnergy : TransmuteEffect
    {
        private static readonly string effectKey = "TransmuteEnergy";
        ...
        public override string GroupName => "TransmuteEnergy"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
