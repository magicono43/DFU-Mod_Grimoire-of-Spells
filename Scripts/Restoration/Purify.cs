...
namespace GrimoireofSpells
{
    public class Purify : BaseEntityEffect
    {
        ...
        public override string GroupName => "Purify"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
