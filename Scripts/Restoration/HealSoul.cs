...
{
    public class HealSoul : HealEffect
    {
        private static readonly string effectKey = "HealSoul";
        ...
        public override string GroupName => "HealSoul"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
