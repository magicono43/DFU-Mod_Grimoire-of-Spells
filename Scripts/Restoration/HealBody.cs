...
{
    public class HealBody : HealEffect
    {
        private static readonly string effectKey = "HealBody";
        ...
        public override string GroupName => "HealBody"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
