...
{
    public class TransmuteSoul : TransmuteEffect
    {
        private static readonly string effectKey = "TransmuteSoul";
        ...
        public override string GroupName => "TransmuteSoul"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
