...
{
    public class TransmuteMind : TransmuteEffect
    {
        private static readonly string effectKey = "TransmuteMind";
        ...
        public override string GroupName => "TransmuteMind"; // Also remember to add potion effects for these later, this one will possibly change the vanilla purification potions if possible.
